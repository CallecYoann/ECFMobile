...
public class FindByChallenge extends AsyncTask<String, Void, List<Regate>> {

    private final String link = "http://10.105.49.5:8080/api/regates/hiver";
...
//                Date dateRegate = convertDate(date_regate);
                ...
                Regate r = new Regate(id_regate, nom_regate);
